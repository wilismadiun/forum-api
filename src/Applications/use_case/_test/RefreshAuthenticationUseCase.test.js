...
describe("RefreshAuthenticationUseCase", () => {
  /**
   * @description
   * This test suite is for the RefreshAuthenticationUseCase, which is responsible for refreshing
   * the authentication tokens (access token and refresh token) of a user.
   */
