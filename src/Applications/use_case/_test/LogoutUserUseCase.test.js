...
describe("LogoutUserUseCase", () => {
  /**
   * @description
   * This test suite is for the LogoutUserUseCase, which is responsible for logging out a user
   * by deleting their refresh token from the authentication repository.
   */
