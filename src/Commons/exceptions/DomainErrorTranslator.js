 ...
 * @description
 * This class is responsible for translating domain-specific error messages into user-friendly
 * invariant errors. It maps specific error messages to their corresponding invariant error messages.
 * It ensures that the application can provide meaningful feedback to users when domain-specific errors occur.
 * @see InvariantError
 */
